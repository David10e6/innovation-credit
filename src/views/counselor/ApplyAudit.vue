<template>
  <div class="apply-audit">
    <el-card>
      ...
      <el-descriptions :column="1" border v-if="applyDetail">
        ...
        <el-descriptions-item label="附件">
          <el-button v-if="applyDetail.proofPath" type="primary" size="small" @click="viewAttachment(applyDetail.proofPath)">查看附件</el-button>
          <span v-else>无</span>
      ...
      <div class="audit-section" v-if="applyDetail">
    ...
    <el-dialog v-model="dialogVisible" title="附件预览" width="80%">
      <div v-if="previewType === 'image'">
        <el-image :src="previewUrl" fit="contain" style="width: 100%; height: 600px">
          <template #error>
...
const viewAttachment = (filePath) => {
  try {
    ...
    if (['jpg', 'jpeg', 'png', 'gif', 'webp'].includes(extension)) {
      ...
      // 使用微软 Office Online Viewer 预览 Office 文档
      previewType.value = 'office'
      previewUrl.value = `https://view.officeapps.live.com/op/view.aspx?src=${encodeURIComponent(url)}`
    } else {
